...
class CakeDetailsActivity1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cake_details1)
    ...
    private fun updatePrice() {
        ...
        val totalPrice = portionCount * 1200 // Assuming price per portion is Rs. 1200
