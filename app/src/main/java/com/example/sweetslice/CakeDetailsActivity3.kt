...
class CakeDetailsActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cake_details3)
    ...
    private fun updatePrice() {
        ...
        val totalPrice = portionCount * 2500 // Assuming price per portion is Rs. 2500
